...
namespace QuantConnect.Tests.Common.Securities
{
    ...
    public class SecurityPortfolioManagerTests
    {
        ...
        public void BuyingSellingFuturesAddsToCashOnClose()
        {
            ...
            securities.Add(
                ...
                new Security(
                    ...
                    CreateTradeBarDataConfig(SecurityType.Future, Symbols.Fut_SPY_Feb19_2016),
                    new Cash(CashBookTests.AccountCurrency, 0, 1m),
                    new SymbolProperties("", CashBookTests.AccountCurrency.ToUpper(), 50, 0.01m, 1),
                    ErrorCurrencyConverter.Instance
                )
            );
        ...
        {
            return new OptionSymbolProperties(SymbolPropertiesDatabase.FromDataFolder().GetSymbolProperties(symbol.ID.Market, symbol, symbol.SecurityType, CashBookTests.AccountCurrency));
        }
